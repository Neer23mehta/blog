...
export const Blogitems = ({ title, description, rating, image, genre, releaseYear, category, id }) => {
    return (
        <div className="bg-white max-w-[300px] w-full flex flex-col shadow-lg rounded-lg overflow-hidden transition-all duration-300 hover:shadow-xl">
            <div className="flex flex-col h-full">
                ...
                <div className="p-4 flex flex-col justify-between flex-1">
                    <p className="text-sm text-white mt-2 bg-black py-1 px-2 rounded-md inline-block">{category}</p>
                    ...
                    <div className="mt-3 flex items-center justify-between">
                        ...
                        <p className="text-sm text-gray-400">Year: {releaseYear}</p>
                    </div>
                    <p className="text-sm text-gray-600 mt-2">Genre: {genre}</p>
                    <Link href={`/blogs/${id}`}>
